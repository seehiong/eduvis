    ...
    ElementSpec(
        ...
        fields=[
            ...
            FieldSpec("marking_scheme", type="array", required=False,
                      items=FieldSpec("mark_rule", type="object", properties=[
                          FieldSpec("step", type="string", required=True, description="Unique step identifier"),
                          FieldSpec("description", type="string", required=False, description="Step requirement description"),
                          FieldSpec("pattern", type="string", required=True, description="Expected answer pattern to match against student working"),
                          FieldSpec("mark_type", type="string", required=False, default="M", enum=["M", "A", "B"],
                                    description="Mark type: M=method, A=accuracy, B=bonus"),
                          FieldSpec("weight", type="integer", required=False, default=1, description="Marks awarded for this step"),
                          FieldSpec("depends_on", type="string", required=False, description="Step ID this step depends on for error carry forward"),
                          FieldSpec("step_type", type="string", required=False, description="Matcher strategy selector (e.g. equation, expression)"),
                          FieldSpec("solution_step_ref", type="integer", required=False,
                                    description="0-based index into solution_steps array; links this marking criterion to the corresponding worked solution step"),
                      ]),
